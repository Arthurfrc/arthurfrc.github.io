...
=== Capítulo 23. Extração de características: Momentos de Hu para contornos https://github.com/Arthurfrc/arthurfrc.github.io/blob/main/exercicio_22/momentos-regioes-2.cpp[momento-regioes-2.cpp] , que rodou com as seguintes imagens para procurar.
