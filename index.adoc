...
[link=https://github.com/Arthurfrc/arthurfrc.github.io/blob/main/exercicio_16/espectro.png]
image::exercicio_16/Espectro.png[]

.Figura 24: Saída do código YAML da imagem
[link=https://github.com/Arthurfrc/arthurfrc.github.io/blob/main/exercicio_16/espectro_2.png]
image::exercicio_16/Espectro_2.png[]
